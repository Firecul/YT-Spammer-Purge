...
def write_log_heading(
    ...
    if filterMode == "ID":
        write_func(
            current.logFileName,
            "Channel IDs of spammer searched: " + ", ".join(filterSettingList),
            logMode,
            2,
        )
        ...
        write_func(
            current.logFileName,
            "Searched in Usernames: " + ", ".join(filterSettingList),
            logMode,
            2,
        )
        ...
        write_func(
            current.logFileName,
            "Searched in Comment Text: " + ", ".join(filterSettingList),
            logMode,
            2,
        )
        ...
        write_func(
            current.logFileName,
            "Searched in Usernames and Comment Text: " + ", ".join(filterSettingList),
            logMode,
            2,
        )
